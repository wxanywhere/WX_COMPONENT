...
namespace ydtf.isoa
{
  ...
  public class excep : Exception
  {
    ...
    private excep_level _exceptionLevel;
    ...
    /// 
    /// </summary>
    public excep_level ExceptionLevel
    {
      get
      {
    ...
    public excep(string message, int errorCode)
    {
      this._exceptionCode = -1;
      this._detailMessage = string.Empty;
    ...
    public excep(string message, excep_level exceptionLevel)
    {
      this._exceptionCode = -1;
      this._detailMessage = string.Empty;
    ...
    /// <param name="exceptionLevel">异常级别</param>
    public excep(string message, int exceptionCode, excep_level exceptionLevel)
    {
      this._exceptionCode = -1;
      this._detailMessage = string.Empty;
    ...
    public excep(string message, excep_level exceptionLevel, Exception innerException)
    {
      this._exceptionCode = -1;
      this._detailMessage = string.Empty;
      this._exceptionLevel = exceptionLevel;
    ...
    /// <param name="exceptionLevel">异常级别</param>
    /// <param name="innerException">内部异常</param>
    public excep(string message, int exceptionCode, excep_level exceptionLevel, Exception innerException)
    {
      this._exceptionCode = -1;
      this._detailMessage = string.Empty;
      this._exceptionCode = exceptionCode;
