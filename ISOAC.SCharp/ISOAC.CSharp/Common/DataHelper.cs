...
namespace ISOA
{
    ...
    public static class DataHelper
    {
        ...
        {
            return GlobalHelper.DataEncoding.GetBytes(dataString);
        }
        ...
        {
            return GlobalHelper.DataEncoding.GetString(dataBytes, 0, dataBytes.Length);
        }
        ...
        {
            return GlobalHelper.DataEncoding.GetString(dataBytes, index, count).Replace("\0", string.Empty);
        }
        ...
        public static byte[] Compress(byte[] source)
        {
            ...
            try
            {
                ...
                DataHelper.CopyStream((Stream)sourceStream, (Stream)zoutputStream);
            }
            finally
            {
