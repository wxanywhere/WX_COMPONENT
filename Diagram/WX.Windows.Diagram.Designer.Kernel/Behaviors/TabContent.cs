...
namespace WX.Windows.Diagram.Designer
{
    ...
    public static class TabContent
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static ContentPresenter GetInternalCachedContent(DependencyObject obj)
        {
            return (ContentPresenter)obj.GetValue(InternalCachedContentProperty);
        }

        [EditorBrowsable(EditorBrowsableState.Never)]
        public static void SetInternalCachedContent(DependencyObject obj, ContentPresenter value)
        {
        ...
        public static readonly DependencyProperty InternalCachedContentProperty =
            DependencyProperty.RegisterAttached("InternalCachedContent", typeof(ContentPresenter), typeof(TabContent), new UIPropertyMetadata(null));
