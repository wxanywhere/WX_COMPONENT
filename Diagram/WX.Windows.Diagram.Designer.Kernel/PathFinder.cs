...
namespace WX.Windows.Diagram.Designer
{
    ...
    {
        private const int margin = 10; //Related with arrow direction
        ...
        {
            Rect rect = new Rect(connectorThumb.DesignItemLeft,
                                 connectorThumb.DesignItemTop,
                                 connectorThumb.DesignItemSize.Width,
                                 connectorThumb.DesignItemSize.Height);
        ...
        private static void CheckPathEnd(ConnectorInfo source, ConnectorInfo sink, bool showLastLine, List<Point> linePoints)
        {
            if (showLastLine)
            {
                ...
                double sourceMarginPath = 0;
                double sinkMarginPath = 3; 
                switch (source.Orientation)
                {
                    case ConnectorOrientation.Left:
                        startPoint = new Point(source.Position.X - sourceMarginPath, source.Position.Y);
                        break;
                    case ConnectorOrientation.Top:
                        startPoint = new Point(source.Position.X, source.Position.Y - sourceMarginPath);
                        break;
                    case ConnectorOrientation.Right:
                        startPoint = new Point(source.Position.X + sourceMarginPath, source.Position.Y);
                        break;
                ...
                {
                    case ConnectorOrientation.Left:
                        endPoint = new Point(sink.Position.X - sinkMarginPath, sink.Position.Y);
                        break;
                    case ConnectorOrientation.Top:
                        endPoint = new Point(sink.Position.X, sink.Position.Y - sinkMarginPath);
                        break;
                    case ConnectorOrientation.Right:
                        endPoint = new Point(sink.Position.X + sinkMarginPath, sink.Position.Y);
                        break;
