...
namespace WX.Windows.Diagram.Designer
{
    public class ResizeDecorator : Control
    {
        ...
        {
            //Unloaded += new RoutedEventHandler(this.ResizeDecorator_Unloaded); //Resolve the issue of swithing tabItem
        }
        ...
        private void ShowAdorner()
        {
            if (this.adorner == null)
            {
                ...
                {
                    ContentControl designItem = this.DataContext as ContentControl;
                    Canvas canvas = VisualTreeHelper.GetParent(designItem) as Canvas;
                    this.adorner = new ResizeAdorner(designItem);
